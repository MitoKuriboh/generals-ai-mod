...
private:
	...
	void countAllForces(MLGameState& state);  // M2 FIX: Single-pass force counting
	void countForces(Real* infantry, Real* vehicles, Real* aircraft, Real* structures, Bool own);  // Legacy
...
// Debug display callback for ML agent - shows recommendations on screen
// Register with TheDisplay->setDebugDisplayCallback(MLAgentDebugDisplay, NULL)
class DebugDisplayInterface;
extern void MLAgentDebugDisplay(DebugDisplayInterface* dd, void* userData, FILE* fp);
